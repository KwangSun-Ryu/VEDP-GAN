...
from generation.TabDDPM.tab_ddpm.modules import MLPDiffusion, ResNetDiffusion
...
def make_dataset(
    ...
    splits = lib.available_splits(data_path)
    if 'train' not in splits or 'test' not in splits:
        raise ValueError(f"Dataset at {data_path} must contain at least 'train' and 'test' splits")
